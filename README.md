...
main.py – Main control loop that runs the simulation

robot.py – Contains robot state, movement, and decision logic

environment.py – Defines the grid environment and obstacle handling
